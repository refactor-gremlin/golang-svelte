...
func TestNewUserValid(t *testing.T) {
	user, err := authdomain.NewUser("test_user", "user@example.com", "hash", "salt")
	if err != nil {
...
func TestNewUserEmptyUsername(t *testing.T) {
	_, err := authdomain.NewUser(" ", "user@example.com", "hash", "salt")
	if err == nil {
...
func TestNewUserEmptyEmail(t *testing.T) {
	_, err := authdomain.NewUser("test_user", " ", "hash", "salt")
	if err == nil {
...
func TestNewUserEmptyHash(t *testing.T) {
	_, err := authdomain.NewUser("test_user", "user@example.com", "", "salt")
	if err == nil {
...
func TestNewUserEmptySalt(t *testing.T) {
	_, err := authdomain.NewUser("test_user", "user@example.com", "hash", "")
	if err == nil {
